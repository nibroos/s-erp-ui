...
const { tabFormIndex, form, errors } = storeToRefs(unitStore);
...
const handleClickClear = () => {
  form.value = cloneObject(useInitials.formUnitCreateEdit);
  errors.value = {};
};
