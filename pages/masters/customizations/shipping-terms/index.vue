...
const { queryModal } = useShippingTermStore();
  ...
  <div class="flex flex-col gap-2">
    ...
    >
      <d-datatable
        ...
        edit-link="/masters/customizations/shipping-terms/edit"
        delete-api="/v1/shipping-terms/delete-shipping-term"
        method-api="post"
        items-prop="data"
        total-prop="meta.total"
        label="Shipping Terms"
        class="col-span-2 lg:col-span-1"
        search-placeholder="Search anything related to shipping terms.."
        no-title
        :fields="fieldsConfig"
        :filters="filtersConfig"
        :query-modal="queryModal.qListIndex"
        :create-option="{
          link: '/masters/customizations/shipping-terms/create',
          show: true,
          cta: '+ Create',
        }"
        @update:filters="
