...
const { queryModal } = usePaymentTermStore();
  ...
  <div class="flex flex-col gap-2">
    ...
    >
      <d-datatable
        ...
        edit-link="/masters/customizations/payment-terms/edit"
        delete-api="/v1/payment-terms/delete-payment-term"
        method-api="post"
        items-prop="data"
        total-prop="meta.total"
        label="Payment Terms"
        class="col-span-2 lg:col-span-1"
        search-placeholder="Search anything related to payment terms.."
        no-title
        :fields="fieldsConfig"
        :filters="filtersConfig"
        :query-modal="queryModal.qListIndex"
        :create-option="{
          link: '/masters/customizations/payment-terms/create',
          show: true,
          cta: '+ Create',
        }"
        @update:filters="
