...
const { tabFormIndex, form, errors } = storeToRefs(categoryTypeStore);
...
const formLayout = ref({
  ...
  button: {
    create: {
      show: true,
      cta: "Create New",
      path: "/masters/customizations/category-types/create",
    },
    save: {
      show: true,
      loading: false,
...
const handleSubmit = async () => {
  await categoryTypeStore.update();
};
...
onMounted(async () => {
  ...
  Promise.all([categoryTypeStore.show()]);
});
</script>
