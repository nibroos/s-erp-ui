...
import useTaskStore from "~/stores/masters/TaskStore";
import type { FormLayoutType } from "~/types/FormLayoutType";

const taskStore = useTaskStore();
const { tabFormIndex, form, errors } = storeToRefs(taskStore);
...
const formLayout = ref({
  ...
  parentPath: "/masters/customizations/tasks",
  mode: "edit",
  ...
  button: {
    create: {
      show: true,
      cta: "Create New",
      path: "/masters/customizations/tasks/create",
    },
    save: {
      show: true,
      loading: false,
...
const handleClickClear = () => {
  form.value = cloneObject(useInitials.formTaskCreateEdit);
  errors.value = {};
};
