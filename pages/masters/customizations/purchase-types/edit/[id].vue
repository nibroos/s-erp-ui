...
const { tabFormIndex, form, errors } = storeToRefs(purchaseTypeStore);
...
const formLayout = ref({
  ...
  parentPath: "/masters/customizations/purchase-types",
  mode: "edit",
  ...
  button: {
    create: {
      show: true,
      cta: "Create New",
      path: "/masters/customizations/purchase-types/create",
    },
    save: {
      show: true,
      loading: false,
...
const handleSubmit = async () => {
  await purchaseTypeStore.update();
};
...
onMounted(async () => {
  ...
  Promise.all([purchaseTypeStore.show()]);
});
</script>
