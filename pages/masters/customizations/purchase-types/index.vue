  ...
  <div class="flex flex-col gap-2">
    ...
    >
      <d-datatable
        ...
        edit-link="/masters/customizations/purchase-types/edit"
        delete-api="/v1/purchase-types/delete-purchase-type"
        method-api="post"
        items-prop="data"
        ...
        :create-option="{
          link: '/masters/customizations/purchase-types/create',
          show: true,
          cta: '+ Create',
        }"
        @update:filters="
