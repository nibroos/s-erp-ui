...
watch(() => invoiceAdjustmentStore.itemsCheck.checkMain, () => {
  calculateTotalAmountLocal();
}, { deep: true });
          ...
          >
            ...
            <template #item.admin_bank="{ item }">
              <d-num-v-format
                ...
                hide-currency-display
                class="w-full"
                @update:modelValue="invoiceAdjustmentStore.updateAdminBankAmount(item, $event)"
              />
            </template>
            ...
            <template #item.actions="{ item, index }">
              <button
                ...
                @click="invoiceAdjustmentStore.onClickDeleteSelected(item, index)"
              >
